...
public class SwaggerResourceConfig implements SwaggerResourcesProvider {
    ...
    public List<SwaggerResource> get() {
        ...
        // 获取所有服务路由 ID
        routeLocator.getRoutes().subscribe((Consumer<? super Route>) route -> routeIdList.add(route.getId()));
        // 生成网关已配置的服务 api-docs 路径
        gatewayProperties.getRoutes()
                ...
                .forEach(routeDefinition -> routeDefinition.getPredicates()
                        ...
                        .forEach(predicateDefinition -> swaggerResourceList.add(swaggerResource(routeDefinition.getId(),
